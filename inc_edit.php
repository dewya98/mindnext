...
<style>
    ...
    <content>
        <form name=frm1 method="POST" action="inc_edit_ok.php">
            <fieldset>
            ...
            <table>
                ...
                <tr>
                <th>파일</th>
                <td><input type="file" name="userfile" placeholder="<?php echo $row["fname"] ?>"></td>
                </tr>
                <tr>
                <th>제목</th>
        ...
        <input type="button" class="button" value="게시판 메인" onclick="location.href='inc.php'">&ensp;

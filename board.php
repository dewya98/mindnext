   ...
   <style>
    ...
    <content>
        ...
        if(isset($_SESSION["id"])){ ?>
         <div class="pager">
            <input type="button" value="자료업로드" class="btn" onclick="location.href='board-add.php'">
        </div><br><br><br>
        <?php }else{ ?> 
            <div class="typing">
            <img src="images/pen/2x/outline_create_black_24dp.png" alt="typing" width="5%" height="5%" style="vertical-align:top;">
            <textarea name="content" cols="70" rows="2" placeholder="&ensp;로그인 하시면 게시글을 작성하실 수 있습니다." readonly></textarea>&ensp;
